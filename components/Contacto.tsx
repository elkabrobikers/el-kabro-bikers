...
export default function Contacto() {
  ...
  return (
    <section id="contacto" className="py-20 bg-black text-white px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <form onSubmit={enviarWhatsApp} className="bg-[#111] p-8 border border-gray-800 h-fit">
            ...
            <input required placeholder="Nombre completo" className="w-full bg-black p-4 mb-4 border border-gray-700 focus:border-purple-600 outline-none" onChange={e => setFormData({...formData, nombre: e.target.value})} />
            <input required placeholder="Modelo de moto" className="w-full bg-black p-4 mb-4 border border-gray-700 focus:border-purple-600 outline-none" onChange={e => setFormData({...formData, modelo: e.target.value})} />
            <textarea required placeholder="Describe el daño" className="w-full bg-black p-4 mb-4 border border-gray-700 h-32 focus:border-purple-600 outline-none" onChange={e => setFormData({...formData, dano: e.target.value})} />
            
            <button type="submit" className="w-full bg-purple-600 py-4 font-bold hover:bg-purple-700 transition flex justify-center items-center gap-2 uppercase tracking-widest">
              Enviar solicitud ✈
            </button>
          </form>
        </div>
